const ticketData = ({ dbs }) => {
  ...
  async function getAllTickets() {
    ...
    const sql =
      "SELECT T.service_ticket_id, T.service_ticket_number, T.date_returned, T.date_received, T.comments, S.service_name, S.hourly_rate, CONCAT(C.firstname, ' ', C.lastname) AS customer_name, CONCAT(M.firstname, ' ', M.lastname) AS mechanic_name,  A.serial_number, A.brand, A.model FROM service_ticket T" +
