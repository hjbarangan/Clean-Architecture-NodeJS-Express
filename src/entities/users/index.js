...
const services = Object.freeze({ userEntity, userLoginEntity, changePasswordEntity, userUpdateEntity });

module.exports = services;

module.exports = {userEntity, userLoginEntity, changePasswordEntity, userUpdateEntity};
